...
const Index = () => {
  ...
  const services = [
    { name: '🎬 Видео от Деда Мороза', desc: 'Ролик 10 секунд', price: 'от 1 490₽' },
    { name: '🎬 Видео от кумира', desc: 'Ролик 10 секунд', price: 'от 1 700₽' },
    ...
    { name: '🎊 Видеоколлажи', desc: 'Ролик 10 секунд', price: 'от 1 599₽' },
    { name: '🎭 Видеосказки', desc: 'Ролик 10 секунд', price: 'от 1 999₽' },
  ];
  ...
  const faq = [
    { q: 'Результат похож на реальный?', a: 'Да, мы стремимся создать самый идентичный до 99% результат, однако так как нейросети, просим вас не ждать идеального результата сразу' },
    { q: 'Сколько займёт по времени?', a: 'От 12 до 48 часов, но сделаем быстрее, оставляем запас на правки' },
    { q: 'А что если не понравится?', a: 'Наши специалисты предлагают несколько решений и всегда готовы внести правки' },
    { q: 'Зачем именно нейроподарок?', a: 'Наступает эпоха подарков нового уровня, в ближайшие 5 лет - нейроподарки будут МегаТрендом, будьте первым в рядах кто подарит такое😍' },
  ];
      ...
      <header className="py-4 px-6 border-b border-white/10 backdrop-blur-sm sticky top-0 z-50 bg-[#0a1f3f]/80">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <a href="#faq" className="hover:text-[#FFD700] transition-colors">Вопросы</a>
          </nav>
          <Button 
