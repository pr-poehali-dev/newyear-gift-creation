...
const Index = () => {
  ...
  const portfolio = [
    ...
    { type: 'video', title: 'Праздничное семейное видео', desc: 'за одним столом с любимыми героями фильмов детства', emoji: '🎭', link: 'https://rutube.ru/shorts/8900b17408081bb4e3c1c966a80de32c/' },
