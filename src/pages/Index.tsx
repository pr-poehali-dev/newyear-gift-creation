...
const Index = () => {
  ...
  const services = [
    { name: '🎬 Видео от Деда Мороза', desc: 'Ролик 10 секунд', price: '1 490₽' },
    { name: '🎬 Видео от кумира', desc: 'Ролик 10 секунд', price: '1 700₽' },
    ...
    { name: '🎊 Видеоколлажи', desc: 'Ролик 10 секунд', price: '1 599₽' },
    { name: '🎭 Видеосказки', desc: 'Ролик 10 секунд', price: '1 999₽' },
  ];
